...
import { Plus, Edit2, List, Trash2, LogOut, Package, LogIn, ClipboardList } from "lucide-react";
...
const Dashboard = () => {
  ...
  const menuOptions = [
    ...
    { id: "orders", icon: ClipboardList, title: "Manage Orders", description: "View and update customer orders" },
  ];
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-4xl">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl font-bold text-black mb-4">Product Management</h1>
            <p className="text-xl text-gray-600">Choose an option to manage your store</p>
          </div>
